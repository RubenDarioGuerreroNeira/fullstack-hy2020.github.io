----------favoritos.js---
// def favoritoBlog(blogs):
//   """
//   Encuentra el blog con más "Me gusta" de una lista de blogs.

//   Args:
//     blogs: Una lista de diccionarios, donde cada diccionario representa un blog 
//            y tiene las claves "title", "author" y "likes".

//   Returns:
//     Un diccionario que representa el blog con más "Me gusta". Si hay varios blogs 
//     con el mismo número máximo de "Me gusta", devuelve uno de ellos al azar.
//   """
...
const listWithOneBlog = [
  ...
  blog_mas_popular = None
  max_likes = 0

  for (const blog in listWithOneBlog){
    if (blog["likes"] > max_likes){
      max_likes = blog["likes"]
      blog_mas_popular = blog
  }
}

  return blog_mas_popular

  const resultado1 = favoritoBlog(listWithOneBlog);
  console.log("Resultado 1:", resultado1); // Debe imprimir el blog con más likes
